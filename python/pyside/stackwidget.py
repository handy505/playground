...
class DemoWindow(QMainWindow):
    ...
    def _initHomePage(self):
        ...
        leftvbox.addWidget(rx_label)
        leftvbox.addWidget(node_summary_label)
        leftvbox.addWidget(serial_pipelines_label)
        leftvbox.addWidget(database_label)
        leftvbox.addWidget(upload_pipelins_label)
        leftvbox.addWidget(feedback_pipelins_label)
        leftvbox.addWidget(psid_label)
        leftvbox.addWidget(upload_label)
