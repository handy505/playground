...
class RecorderThread(threading.Thread):
    def __init__(self, inputpipeline, outputpipeline):
        super().__init__()
...
class MainThread(threading.Thread):
    def __init__(self):
        ...
        self.pipeline1 = queue.Queue()
        self.pipeline2 = queue.Queue()

        self.ct = CollectorThread(self.inverters, self.pipeline1)
        self.rt = RecorderThread(self.pipeline1, self.pipeline2)
        self.ut = UploaderThread(self.pipeline2)
