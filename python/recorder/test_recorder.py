...
class TestRecorder(unittest.TestCase):
    ...
    def test_append_record(self):
        ...
        self.assertEqual(8, len(self.mydb.dc))
        ...
        self.assertEqual(9, len(self.mydb.dc))
        self.assertEqual(1, self.mydb.processing_key)
    ...
    def test_get_record(self):
        ...
        self.assertEqual(7, len(self.mydb.dc))
    ...
    def test_delete_record(self):
        ...
        self.assertEqual(6, len(self.mydb.dc))
        self.mydb.delete_record(1)
        self.assertEqual(6, len(self.mydb.dc))
        self.mydb.delete_record(2)
        self.assertEqual(5, len(self.mydb.dc))
